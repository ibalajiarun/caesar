 ...
 */
public final class SpecRetryReply extends Message {
    ...
    public SpecRetryReply(int view, RequestId rId, byte[] pred, int predSize) {
        super(view);
        this.requestId = rId;
        this.bytePred = pred;
    ...
    public SpecRetryReply(DataInputStream input) throws IOException {
        super(input);
    ...
    public MessageType getType() {
        return MessageType.SpecRetryReply;
    }
