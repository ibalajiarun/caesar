...
public final class SpecRetry extends Message {
    ...
    public SpecRetry(int view, Request request) {
        super(view);
    ...
    public SpecRetry(DataInputStream input) throws IOException {
        super(input);
        ...
        request = new Request(requestId, objectIds, payload, position, pred, RequestStatus.SpecAccepted, view);
    }

    public MessageType getType() {
        return MessageType.SpecRetry;
    }
